...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        WHERE tablename = 'affiliates' AND policyname = 'Authenticated users can view affiliates'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'email_campaigns' AND policyname = 'Authenticated users can view email campaigns'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'landing_pages' AND policyname = 'Authenticated users can view landing pages'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'leads' AND policyname = 'Authenticated users can view leads'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'deals' AND policyname = 'Authenticated users can view deals'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'activities' AND policyname = 'Authenticated users can view activities'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'activities' AND policyname = 'Authenticated users can manage activities'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'seo_analysis' AND policyname = 'Authenticated users can view SEO analysis'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'seo_analysis' AND policyname = 'Authenticated users can manage SEO analysis'
    ) THEN
...
BEGIN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger 
        WHERE tgname = 'handle_seo_analysis_updated_at'
    ) THEN
        CREATE TRIGGER handle_seo_analysis_updated_at 
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        WHERE indexname = 'idx_affiliates_status'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_indexes 
        WHERE indexname = 'idx_affiliates_tier'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_indexes 
        WHERE indexname = 'idx_affiliates_referral_code'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_indexes 
        WHERE indexname = 'idx_email_campaigns_status'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_indexes 
        WHERE indexname = 'idx_email_campaigns_campaign_type'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_indexes 
        WHERE indexname = 'idx_landing_pages_status'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_indexes 
        WHERE indexname = 'idx_landing_pages_slug'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_indexes 
        WHERE indexname = 'idx_leads_status'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_indexes 
        WHERE indexname = 'idx_leads_assigned_to'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_indexes 
        WHERE indexname = 'idx_deals_stage'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_indexes 
        WHERE indexname = 'idx_deals_client_id'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_indexes 
        WHERE indexname = 'idx_activities_type'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_indexes 
        WHERE indexname = 'idx_seo_analysis_domain'
    ) THEN
