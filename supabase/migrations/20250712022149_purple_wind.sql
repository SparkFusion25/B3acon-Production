...
-- Add Stripe customer ID to profiles if it doesn't exist
DO $$ 
BEGIN
  IF NOT EXISTS (
...
CREATE TRIGGER handle_subscription_items_updated_at
...
CREATE POLICY "Admins can view all subscription items"
...
-- Users can view their own subscription items
