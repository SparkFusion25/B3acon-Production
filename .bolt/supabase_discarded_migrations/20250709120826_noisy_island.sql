/*
# B3ACON Database Migration - Complete Setup

This migration sets up the complete B3ACON database schema with:
1. Custom enum types for roles and statuses
2. All core tables for CRM, email marketing, landing pages, and affiliates
3. Row Level Security policies
4. Performance indexes
5. Sample data for immediate testing

All statements use IF NOT EXISTS or DO $$ blocks to handle existing objects gracefully.
*/
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'profiles' AND policyname = 'Service role can manage profiles') THEN
        CREATE POLICY "Service role can manage profiles" ON profiles FOR ALL USING (
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'clients' AND policyname = 'Authenticated users can view clients') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'affiliates' AND policyname = 'Authenticated users can manage affiliates') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'affiliate_links' AND policyname = 'Authenticated users can view affiliate data') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'affiliate_referrals' AND policyname = 'Authenticated users can manage affiliate referrals') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'affiliate_commissions' AND policyname = 'Authenticated users can manage commissions') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'email_campaigns' AND policyname = 'Authenticated users can manage email campaigns') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'email_lists' AND policyname = 'Authenticated users can manage email lists') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'email_subscribers' AND policyname = 'Authenticated users can manage subscribers') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'email_automations' AND policyname = 'Authenticated users can manage automations') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'email_templates' AND policyname = 'Users can view public templates') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'landing_pages' AND policyname = 'Authenticated users can manage landing pages') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'landing_page_templates' AND policyname = 'Users can view public templates') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'landing_page_forms' AND policyname = 'Authenticated users can manage forms') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'white_label_partners' AND policyname = 'Authenticated users can manage white label partners') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'api_keys' AND policyname = 'Agency users can manage API keys') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'api_keys' AND policyname = 'Agency users can view API keys') THEN
...
-- Create updated_at triggers (drop and recreate to avoid conflicts)
