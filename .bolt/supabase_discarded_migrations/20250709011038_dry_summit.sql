/*
  # Add Sample Data for B3ACON Platform

  1. Sample Data Added
    - 4 sample clients with different subscription tiers
    - 4 sample leads in various stages
  ...
  2. Data Features
    ...
    - Complete affiliate program data
    - Email marketing examples
    - Landing page templates

  This migration populates the platform with sample data for testing and demonstration.
*/
